...
ELF_FILE="$ROOT_DIR/build/subtractive/subtractive/Debug/subtractive.elf"
BITSTREAM_FILE="$ROOT_DIR/build/subtractive/subtractive/_ide/bitstream/eight_voice_uart_harms.bit"
PS_INIT_TCL="$ROOT_DIR/build/subtractive/subtractive/_ide/psinit/ps7_init.tcl"
